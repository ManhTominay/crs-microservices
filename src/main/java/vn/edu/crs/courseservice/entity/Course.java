// path: course-service/src/main/java/vn/edu/crs/courseservice/entity/Course.java
package vn.edu.crs.courseservice.entity;
// purpose: entity anh xa bang course trong database course_dbpackage vn.edu.crs.courseservice.entity;
